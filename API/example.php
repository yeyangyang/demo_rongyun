...
$RongCloud = new RongCloud($appKey,$appSecret);
	...
	echo ("\n***************** user **************\n");
	// 获取 Token 方法
	$result = $RongCloud->user()->getToken('userId4', 'username4', 'http://www.rongcloud.cn/images/logo.png');
	echo "getToken    ";
	print_r($result);
	echo "\n";
	echo "<br>";
	...
	// 刷新用户信息方法
	$result = $RongCloud->user()->refresh('userId4', 'username4', 'http://www.rongcloud.cn/images/logo.png');
	echo "refresh    ";
	print_r($result);
	echo "\n";
	echo "<br>";
	...
	// 检查用户在线状态 方法
	$result = $RongCloud->user()->checkOnline('userId4');
	echo "checkOnline    ";
	print_r($result);
	echo "\n";
	echo "<br>";
	...
	// 封禁用户方法（每秒钟限 100 次）
	$result = $RongCloud->user()->block('userId1', '10');
	echo "block    ";
	print_r($result);
	echo "\n";
	
	// 解除用户封禁方法（每秒钟限 100 次）
	$result = $RongCloud->user()->unBlock('userId1');
	echo "unBlock    ";
	print_r($result);
	echo "\n";
